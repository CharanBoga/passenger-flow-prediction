...
--
-- Host: localhost
-- Generation Time: Jul 27, 2023 at 01:13 PM
...
--
-- Database: `adaptive_feature_fusion_networks`
--
CREATE DATABASE IF NOT EXISTS `adaptive_feature_fusion_networks` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `adaptive_feature_fusion_networks`;
...
('6h7f2lif2b5xzckoqy0dzpuf2ssln6u6', 'eyJ1c2VyaWQiOjJ9:1oOxNy:rn921d2FdMCS42DJKaBJnAlT20byTRiY2P4X7Wm76Qc', '2022-09-02 08:29:46.357161'),
...
('gjiyh16cgndolqc4oqee994jt68pxsy7', 'eyJ1c2VyaWQiOjN9:1qP098:aMDJOqqZUdU0f1OGP0D2n2P2-6w6ba_asVAHV0vlIfA', '2023-08-10 12:31:10.630286'),
...
('r0lswf36qh5gt0i2afmqqeu550j9vohq', 'eyJ1c2VyaWQiOjF9:1oOvxv:-o0Ngd4h_vqB4DUhIuathTt7_CkrfaHFDCAmdaRTbwU', '2022-09-02 06:58:47.164716'),
...
('uxa6dye77qbbc9ukidbuhut9n1p2dyki', 'eyJ1c2VyaWQiOjR9:1qP0jC:CAjaYBEX25boqmpRHSplch8rL8Fb96wBCd6083LYLM8', '2023-08-10 13:08:26.584545'),
...
(3, 'Gopinath', 'Gopinath123@gmail.com', 'Gopinath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#902,4th Cross,Rajajinagar', 'Male'),
(4, 'Manjunath', 'tmskmanju19@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male');
...
(77, 'Multi-Graph Convolution Gated Recurrent Unit--EMGC-GRU', '47.05882352941176'),
(78, 'SVM', '51.9607843137255'),
(79, 'Logistic Regression', '53.92156862745098'),
(80, 'Gradient Boosting Classifier', '52.94117647058824');
...
(42, 'High Passenger Flow', '50.0'),
(43, 'Low Passenger Flow', '50.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_passenger_flow_prediction`
--

CREATE TABLE IF NOT EXISTS `remote_user_passenger_flow_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fid` varchar(300) NOT NULL,
  `Tripid` varchar(300) NOT NULL,
  `Metro_Name` varchar(300) NOT NULL,
  `City` varchar(300) NOT NULL,
  `Source` varchar(300) NOT NULL,
  `Destination` varchar(300) NOT NULL,
  `Date_Time` varchar(300) NOT NULL,
  `NumberOfBoardings` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=14 ;

--
-- Dumping data for table `remote_user_passenger_flow_prediction`
--

INSERT INTO `remote_user_passenger_flow_prediction` (`id`, `Fid`, `Tripid`, `Metro_Name`, `City`, `Source`, `Destination`, `Date_Time`, `NumberOfBoardings`, `Prediction`) VALUES
(9, '10.42.0.211-66.198.24.224-54490-443-6', '10167', 'BMRCL', 'Bangalore', 'Jnanabharathi', 'Pattanagere', '2022-05-23T21:24:23.000Z', '49', 'Low Passenger Flow'),
(10, '220.170.182.31-10.42.0.211-443-37058-6', '10167', 'BMRCL', 'Bangalore', 'Srirampura', 'Kuvempu Road', '2022-05-17T00:03:40.000Z', '34', 'High Passenger Flow'),
(12, '172.217.10.106-10.42.0.151-443-49919-6', '10167', 'BMRCL', 'Bangalore', 'Deepanjali Nagara', ' Mysuru Road', '2022-06-16T18:11:02.000Z', '32', 'High Passenger Flow'),
(13, '10.42.0.151-10.42.0.1-48795-53-17', '10170', 'Hydrabad Metro Rail', 'Hydrabad', 'Victoria Memorial', 'Chaitanyapuri', '2022-06-15T20:26:17.000Z', '36', 'Low Passenger Flow');
